      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card card-refresh">
            ...
            <div class="card-header card-header-action">
              ...
              <div class="d-flex align-items-center">
                <nuxt-link
                  ...
                  :to="localePath('/panel/settings/add')"
            ...
            <div class="card-body">
              <BackendDatatable
                :dataurl="$config.API_URL + '/panel/settings/datatable'"
                :rankurl="$config.API_URL + '/panel/settings/rank/'"
                :isactiveurl="$config.API_URL + '/panel/settings/isactive/'"
