...
class EmailSettingsController extends MY_Controller
{
    ...
    public function index_get($id = null)
    {
        if ($this->token) :
            ...
            if (!empty($id)) :
                $emailsettings = $this->general_model->get("email_settings", null, ["id" => $id]);
                $this->alert["status"] = TRUE;
                $this->alert["title"] = lang("successfully");
                $this->alert["message"] = lang("received");
                $this->alert["data"] = $emailsettings;
    ...
    public function datatable_post()
    {
        ...
        if ($this->token) :
            ...
            $items = $this->general_model->getRows("email_settings", [], $this->post(null, true));
            $data = [];
            if (!empty($items)) :
            ...
            $output = [
                "recordsTotal" => $this->general_model->rowCount("email_settings"),
                "recordsFiltered" => $this->general_model->countFiltered("email_settings", [], (!empty($this->post(null, true)) ? $this->post(null, true) : [])),
                "data" => $data,
            ];
        endif;
    ...
    public function rank_put($id = null)
    {
        if ($this->token) :
            ...
            if ($this->general_model->update("email_settings", ["id" => $id], ["rank" => $this->put('rank', true)])) :
                $this->alert["status"] = TRUE;
                $this->alert["title"] = lang("successfully");
    ...
    public function isactive_put($id = null)
    {
        if ($this->token) :
            ...
            if ($this->general_model->update("email_settings", ["id" => $id], ["isActive" => $isActive])) :
                $this->alert["status"] = TRUE;
                $this->alert["title"] = lang("successfully");
    ...
    public function save_post()
    {
        if ($this->token) :
            ...
            $data["rank"] = $this->general_model->rowCount("email_settings") + 1;
            if ($this->general_model->add("email_settings", $data)) :
                $this->alert["status"] = TRUE;
                $this->alert["title"] = lang("successfully");
    ...
    public function update_post($id = null)
    {
        if ($this->token) :
            ...
            if (!empty($id)) :
                $settings = $this->general_model->get("email_settings", null, ["id" => $id]);
                if (!empty($settings)) :
                    $data = $this->post(null, true);
                    if ($this->general_model->update("email_settings", ["id" => $id], $data)) :
                        $this->alert["status"] = TRUE;
                        $this->alert["title"] = lang("successfully");
    ...
    public function delete_delete($id = null)
    {
        if ($this->token) :
            ...
            if ($this->general_model->delete("email_settings", ["id" => $id])) :
                $this->alert["status"] = TRUE;
                $this->alert["title"] = lang("successfully");
    ...
    public function delete_post()
    {
        if ($this->token) :
            ...
            if (!empty($this->post("id", true))) :
                ...
                if ($this->general_model->deleteBulk("email_settings", "id", $ids)) :
                    $this->alert["status"] = TRUE;
                    $this->alert["title"] = lang("successfully");
                    $this->alert["message"] = lang("deleted");
                    $this->response($this->alert, MY_Controller::HTTP_OK);
