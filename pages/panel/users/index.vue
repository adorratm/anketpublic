      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card card-refresh">
            ...
            <div class="card-body">
              <BackendDatatable
                :dataurl="$config.API_URL + '/panel/users/datatable'"
                :rankurl="$config.API_URL + '/panel/users/rank/'"
                :isactiveurl="$config.API_URL + '/panel/users/isactive/'"
