      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card card-refresh">
            ...
            <div class="card-header card-header-action">
              ...
              <div class="d-flex align-items-center">
                <nuxt-link
                  ...
                  :to="localePath('/panel/email-settings/add')"
            ...
            <div class="card-body">
              <BackendDatatable
                :dataurl="$config.API_URL + '/panel/email-settings/datatable'"
                :rankurl="$config.API_URL + '/panel/email-settings/rank/'"
                :isactiveurl="
                  $config.API_URL + '/panel/email-settings/isactive/'
                "
                :editurl="'/panel/email-settings/update/'"
                :deleteurl="$config.API_URL + '/panel/email-settings/delete/'"
