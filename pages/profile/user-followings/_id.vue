<template>
  <div class="col-lg-8">
      ...
      <div class="pl-content">
        <div class="input-group">
          ...
          <button
            ...
            type="button"
            @click.prevent="getUserFollowings"
          >
    ...
    <div
      ...
      v-if="userFollowings"
    >
      <div class="col-sm-4 mb-3" v-for="item in userFollowings" :key="item.id">
      ...
      <div
        ...
        v-if="recordsFiltered > userFollowings.length"
      >
          ...
          <ul class="pagination justify-content-center text-center">
            <li :class="['page-item', { disabled: currentPage === 1 }]">
              <a
                ...
                title="Önceki Sayfa"
                class="page-link"
                @click.prevent="(currentPage -= 1), getUserFollowings()"
            ...
            >
              <a
                ...
                title="Sonraki Sayfa"
                class="page-link"
                @click="(currentPage += 1), getUserFollowings()"
                href="javascript:void(0)"
                aria-label="Next"
              >
                <span
...
export default {
  ...
  mounted() {
    ...
    this.$store.commit("SET_BREADCRUMB", {
      showBreadCrumb: true,
      breadCrumbTitle:
        this.$route.params.id + " " + this.$t("profile.userFollowings"),
    ...
    async getUserFollowings() {
      try {
        const { data } = await this.$axios.get(
          "user-followings/" + this.$route.params.id,
          {
            params: {
  ...
  head() {
    return {
      ...
      title: this.$route.params.id + " " + this.$t("profile.userFollowings"),
    };
  },
};
</script>