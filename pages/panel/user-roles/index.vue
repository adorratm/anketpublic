      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card card-refresh">
            ...
            <div class="card-header card-header-action">
              ...
              <div class="d-flex align-items-center">
                <nuxt-link
                  ...
                  :to="localePath('/panel/user-roles/add')"
            ...
            <div class="card-body">
              <BackendDatatable
                :dataurl="$config.API_URL + '/panel/user-roles/datatable'"
                :rankurl="$config.API_URL + '/panel/user-roles/rank/'"
                :isactiveurl="$config.API_URL + '/panel/user-roles/isactive/'"
