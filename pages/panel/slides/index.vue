          ...
          <div class="card card-refresh">
            ...
            <div class="card-header card-header-action">
              <div class="flex-grow-1">
                <h6 class="mb-10">
                  {{ $t("panel.slides.slides") }}
                </h6>
                <p class="font-14 w-80">
                  {{ $t("panel.slides.slidesDesc") }}
                </p>
              </div>
              <div class="d-flex align-items-center">
                <nuxt-link
                  ...
                  :to="localePath('/panel/slides/add')"
            ...
            <div class="card-body">
              <BackendDatatable
                :dataurl="$config.API_URL + '/panel/slides/datatable'"
                :rankurl="$config.API_URL + '/panel/slides/rank/'"
                :isactiveurl="$config.API_URL + '/panel/slides/isactive/'"
                :editurl="'/panel/slides/update/'"
                :deleteurl="$config.API_URL + '/panel/slides/delete/'"
  ...
  data() {
    return {
      columns: [
        ...
        {
          label: this.$i18n.t("panel.slides.title"),
          field: "title",
          html: true,
          type: "string",
        },
